...
var waitFor = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(predicate, options) {
    var _ref2, _ref2$timeout, timeout, _ref2$wait, wait, sleep, startDate, counter, result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            startDate = new Date();
            counter = 0; //const result = await predicate();
          ...
          case 12:
            console.log(">> ATTEMPT(".concat(++counter, "): Element WAS NOT FOUND in the current DOM. Will try again after ").concat(wait, "ms"));
            _context.next = 4;
            break;
